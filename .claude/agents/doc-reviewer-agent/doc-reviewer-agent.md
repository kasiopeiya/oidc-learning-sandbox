...
#### ステップ 4-4: TODOコメントの検出

ドキュメント内の `TODO` コメントを検出し、**改善点としては扱わない**。

- `TODO:` `TODO（` `// TODO` `<!-- TODO` などのパターンを検索
- 検出した TODO は「確認点」として記録する（内容を変更・削除の対象としない）
- TODO は意図的に残された未解決事項であるため、指摘・修正対象から除外する

#### ステップ 4-5: プロジェクトルール準拠チェック
