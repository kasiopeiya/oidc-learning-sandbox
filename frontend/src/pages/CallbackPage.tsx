...
export function CallbackPage() {
  ...
  const { user, account, isLoading, error, setUser, setAccount, setIsLoading, setError } = useAuth()
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full px-6 py-8 bg-white shadow-md rounded-lg">
        ...
        <dl className="mb-6 space-y-4">
          <div>
            <dt className="text-sm font-semibold text-gray-700">メールアドレス</dt>
        ...
        <div className="mt-8 p-5 border border-gray-200 rounded-lg bg-gray-50">
          ...
          {/* ローディング表示 */}
          {isLoading && <p className="text-gray-500 italic">口座を作成中...</p>}
